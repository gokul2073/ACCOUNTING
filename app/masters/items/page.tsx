      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-1">
            Manage goods and service items, HSN/SAC classifications, GST tax rates, and reorder levels.
          </p>
        </div>
        <button
      ...
      {showModal && (
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <form onSubmit={handleCreate} className="bg-white rounded-xl shadow-2xl max-w-lg w-full p-6 space-y-4 border border-slate-200">
            <h3 className="text-base font-bold text-slate-900">Add New Product / Service</h3>
            <div className="grid grid-cols-2 gap-3 text-xs">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full p-2 border border-slate-200 rounded font-semibold"
                >
                  <option value="GOODS">GOODS (Tracks Inventory)</option>
                  <option value="SERVICES">SERVICES (No Inventory)</option>
                </select>
              </div>
              <div>
